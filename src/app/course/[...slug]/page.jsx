        ...
        <div>
            ...
            <div>
                <div className='ml-[400px] px-8'>
                    <div className='flex'>
                        <MainVideoSummary chapter={chapter} chapterIndex={chapterIndex} unitName={unit.name} unitIndex={unitIndex}/>
                        {
                            (chapter.questions) &&
                    ...
                    <div
                        className='flex-[1] h-[1px] mt-4 text-gray-500 bg-gray-500'
                    />
